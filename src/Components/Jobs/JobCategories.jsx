...
const JobCategories = () => {
    ...
    return (
        <div>
            ...
            <div className="md:bg-[#eff6f3] md:pt-24 pb-14 my-8">
                <div className="container mx-auto" >
                    <div className="text-left mb-16 relative">
                        <h1 className="lg:text-6xl text-center md:text-left text-4xl font-bold ml-2">Most Demanding Categories</h1>
                    ...
                    <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
                        <TabList>
                            <div className="border border-gray-400 mx-2 rounded-xl lg:w-[65%] lg::mx-auto md:mx-0 md:grid grid-cols-3">
